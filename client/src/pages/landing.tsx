    ...
    <div className="min-h-screen bg-slate-50 font-sans text-foreground overflow-x-hidden">
      ...
      <section className="relative py-16 sm:py-24 lg:py-32 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center relative z-10">
          ...
          >
            {t.hero.title}{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent">{t.hero.titleHighlight}</span>
          </motion.h1>
          <motion.p
      ...
      <footer className="py-8 bg-slate-900 text-slate-400">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex flex-col items-center gap-3 text-center">
          <div className="flex items-center gap-2">
            <img src={onsetLogo} alt="onset." className="w-6 h-6 rounded mix-blend-screen" />
